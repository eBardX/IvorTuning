...
extension TuningSystem where Self == LinearTemperament {
    ...
    /// are distinct.
    public static var pythagorean: LinearTemperament {
        .pythagorean
    }
    ...
    public static var quarterCommaMeantone: LinearTemperament {
    ...
    public static var sixthCommaMeantone: LinearTemperament {
        .sixthCommaMeantone
    }
    ...
    public static var thirdCommaMeantone: LinearTemperament {
        .thirdCommaMeantone
    }
...
extension LinearTemperament {
    ...
    fileprivate static let pythagorean             = LinearTemperament()
    fileprivate static let quarterCommaMeantone    = LinearTemperament(narrowingRatio: syntonicComma.div(4))
    fileprivate static let sixthCommaMeantone      = LinearTemperament(narrowingRatio: syntonicComma.div(6))
    fileprivate static let thirdCommaMeantone      = LinearTemperament(narrowingRatio: syntonicComma.div(3))
    fileprivate static let twoSeventhCommaMeantone = LinearTemperament(narrowingRatio: syntonicComma.mul(2, 7))
}
